...
Load `skill://us-concise` before responding. Use only native read-only inspection and bounded, safe local reproduction. Do not edit files, install dependencies, start shared services, publish anything, access production, or launch another worker.
