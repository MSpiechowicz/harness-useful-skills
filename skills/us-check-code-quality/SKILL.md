...
Load `skill://us-concise` before preparing context or findings. Audit actual architecture and language conventions, not personal formatting preferences. This audit does not authorize application-code refactoring.
